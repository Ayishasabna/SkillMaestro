  ...
  factory UserChatListModel.fromJson(Map<String, dynamic> json) =>
      UserChatListModel(
        sortedUsers: json["sortedUsers"] == null
            ? []
            : List<SortedUser>.from(
                json["sortedUsers"]!.map((x) => SortedUser.fromJson(x))),
        connectionCount: json["connectionCount"] == null
            ? []
            : List<ConnectionCount>.from(json["connectionCount"]!
                .map((x) => ConnectionCount.fromJson(x))),
      );

  Map<String, dynamic> toJson() => {
        "sortedUsers": sortedUsers == null
            ? []
            : List<dynamic>.from(sortedUsers!.map((x) => x.toJson())),
        "connectionCount": connectionCount == null
            ? []
            : List<dynamic>.from(connectionCount!.map((x) => x.toJson())),
      };
}
...
class ConnectionCount {
  ...
  factory ConnectionCount.fromJson(Map<String, dynamic> json) =>
      ConnectionCount(
        userId: json["userId"],
        count: json["count"],
      );
