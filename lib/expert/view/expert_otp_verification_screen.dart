...
class ExpertOtpScreen extends StatelessWidget {
  ExpertOtpScreen({required this.mobile, super.key});
  final String mobile;
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          context.watch<ExpertProvider>().isLoadingOtp
                                  ...
                                  onPressed: () {
                                    ...
                                    if (otpvalidated == 'false') {
                                      ...
                                      var otp = field1.text +
                                          ...
                                          field5.text +
                                          field6.text;
                                      ExpertProvider().verifyExpertOtp(
                                          context, otp, mobile);
                                    }
                                  },
                                  style: ButtonStyle(
